...
; Template & catalog fluxes
 openr,lun,'uds.v1.5.5/uds.v1.5.5.tempfilt',/swap_if_big_endian,/get_lun
...
; 
; Coeffs (OBS_SED)
 openr,lun,'uds.v1.5.5/uds.v1.5.5.coeff',/get_lun,/swap_if_big_endian
 s = lonarr(4) & readu,lun,s
 NFILT=s[0] & NTEMP = s[1] & NZ = s[2] & NOBJ = s[3]
...
; Full templates (TEMP_SED)
 openr,lun,'uds.v1.5.5/uds.v1.5.5.temp_sed',/get_lun,/swap_if_big_endian
...
; 
; POFZ
 openr,lun,'uds.v1.5.5/uds.v1.5.5.pz',/get_lun,/swap_if_big_endian
...
; 
; Stored z values
 openr,lun,'uds.v1.5.5/uds.v1.5.5.zbin',/get_lun,/swap_if_big_endian
