...
; Template & catalog fluxes
 openr,lun,'cosmos.v1.3.3/cosmos.v1.3.3.tempfilt',/swap_if_big_endian,/get_lun
...
; 
; Coeffs (OBS_SED)
 openr,lun,'cosmos.v1.3.3/cosmos.v1.3.3.coeff',/get_lun,/swap_if_big_endian
 s = lonarr(4) & readu,lun,s
 NFILT=s[0] & NTEMP = s[1] & NZ = s[2] & NOBJ = s[3]
...
; Full templates (TEMP_SED)
 openr,lun,'cosmos.v1.3.3/cosmos.v1.3.3.temp_sed',/get_lun,/swap_if_big_endian
...
; 
; POFZ
 openr,lun,'cosmos.v1.3.3/cosmos.v1.3.3.pz',/get_lun,/swap_if_big_endian
...
; 
; Stored z values
 openr,lun,'cosmos.v1.3.3/cosmos.v1.3.3.zbin',/get_lun,/swap_if_big_endian
